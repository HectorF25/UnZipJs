...
function downloadArrayBuffer(arrayBuffer, type, fileName) {
...
export { bufferToStream, downloadArrayBuffer, msdosTimeToDate, readString, readUint16, readUint32, readUint8, streamToBlob, unixTimestampToDate };
